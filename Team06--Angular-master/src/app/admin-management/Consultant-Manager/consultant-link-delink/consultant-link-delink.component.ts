...
@Component({
  selector: 'app-consultant-link-delink',
  templateUrl: './consultant-link-delink.component.html',
  styleUrls: ['./consultant-link-delink.component.css']
})
export class ConsultantLinkDelinkComponent implements OnInit {
  ...
  loadConsultants(): void {
    this.accountService.GetManagerConsultants().subscribe({
      next: (consultants) => {
