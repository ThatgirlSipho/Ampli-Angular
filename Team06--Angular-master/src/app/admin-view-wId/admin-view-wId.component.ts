...
@Component({
  selector: 'app-admin-view-wId',
  templateUrl: './admin-view-wId.component.html',
  styleUrls: ['./admin-view-wId.component.css']
})
export class AdminViewWIdComponent implements OnInit {
