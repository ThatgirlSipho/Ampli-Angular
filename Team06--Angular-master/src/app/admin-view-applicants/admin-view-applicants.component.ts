...
@Component({
  selector: 'app-admin-view-applicants',
  templateUrl: './admin-view-applicants.component.html',
  styleUrls: ['./admin-view-applicants.component.css']
})
export class AdminViewApplicantsComponent {
  ...
  viewApplication(applicantId: number): void {
    if (applicantId && applicantId > 0) {
      this.router.navigate(['/admin-view-applicant', applicantId] );
    } else {
