...
export class ViewApplicantComponent {
  ...
  //   dialogRef.afterClosed().subscribe(result => {
  //     if (result?.confirmed) {
  //       console.log(`Applicant with email ${email} has been deleted for reason: ${result.reason}`);
  //       // Add your deletion logic here, e.g., call a service to delete the applicant
  //     } else {
  //       console.log(`Deletion cancelled for applicant with email ${email}.`);
  //     }
  //   });
  // }
}
