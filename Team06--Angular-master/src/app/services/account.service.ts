...
import { Login, Login2FARequest,BackupScheduleRequest } from './model';
...
constructor(private httpClient: HttpClient) { }
    ...
    backupDatabase(): Observable<any> {
      return this.httpClient.post(`${this.apiUrl}Backup/backup`,{});
    }
         
    restoreDatabase(): Observable<any> {
      return this.httpClient.post(`${this.apiUrl}Backup/restore`,{});
    }
    scheduleBackup(schedule: any): Observable<any> {
      return this.httpClient.post(`${this.apiUrl}Backup/schedule-backup`, schedule);
    }

    getLastBackupDate(): Observable<any> {
      return this.httpClient.get(`${this.apiUrl}Backup/last-backup`);
    }
  
    // Method to get the last scheduled backup
    getLastScheduledBackup(): Observable<any> {
      return this.httpClient.get(`${this.apiUrl}Backup/last-scheduled-backup`);
    }
   /*  ConfirmRegistrationRequest(token: string,email: string ): Observable<any> {
    ...
    GetMyConsultants(): Observable<any> {
      return this.httpClient.get(`${this.apiUrl}Administration/GetUserManagerConsultants`);
    }
