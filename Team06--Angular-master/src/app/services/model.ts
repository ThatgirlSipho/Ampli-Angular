...
export interface Application {
  ...
  accounts: Account[];
 /*  numberofFixedDevices:number;
  numberofMobibleDevices:number; */
...
export interface AuthorizedSignatory {
  ...
  //legalEntityDependant: LegalEntityDependant;
}
...
//  shareholderBoolean: boolean;
  shareholderId:number;
  applicationId:number;
  shareholderLegalEntityName: string;
  //shareholderLegalEntityStructure: string;
  legalEntityStructureId:number;
}
...
export interface BackupScheduleRequest {
  time: string;
  frequency: string;
  dayOfWeek?: string; // For weekly backups
  dayOfMonth?: number; 
}